...
<script src="<?=site_url('js/fflproject.js?1.12')?>"></script>
<script src="<?=site_url('js/fflproject-sse.js?1.18')?>"></script>
<script src="<?=site_url('js/fflproject-chat.js?1.10')?>"></script>
